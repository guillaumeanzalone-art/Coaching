-- Determine the athlete's current week from the last accepted/validated set.
-- A set only advances the difficulty leaderboard when workout_sets.completed = true.
-- Mere load/RPE edits on pending sets no longer advance the displayed week.
