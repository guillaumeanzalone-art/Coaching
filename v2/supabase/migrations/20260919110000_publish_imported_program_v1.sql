-- ============================================================================
-- GA COACHING V2 - GOOGLE SHEETS IMPORTER
-- Publie le programme actif V2 et son bloc courant V3 dans une seule transaction.
-- ============================================================================
...
as $$
declare
  v_athlete_slug text := lower(btrim(coalesce(p_athlete_slug, '')));
...
begin
  ...
  -- Serialise les publications du même programme pour garantir une version unique.
