...
-- Existing finish_rpg_combat_v166 already grants +1 toward the boss.
-- This function grants only the extra amount required by the rarity weight.
-- combat_id is unique to prevent the normal web client from awarding twice.
...
alter table public.rpg_boss_progress_awards_web_v2
  enable row level security;

revoke all
on table public.rpg_boss_progress_awards_web_v2
...
revoke all
on function public.award_rpg_boss_progress_rarity_web_v2(
  text,
  text,
  text
)
