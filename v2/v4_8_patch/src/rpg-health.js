...
function multiplierCopy(steps) {
  ...
  if (steps < 10000) {
    return {
      title: 'XP ×1 demain',
      text: `${formatNumber(10000 - steps)} pas avant le début du bonus.`,
    }
  }
  ...
  if (steps < 20000) {
    return {
      ...
      text: `${formatNumber(20000 - steps)} pas avant XP ×2.`,
    }
  }
  ...
  return `
    <section class="rpg-health-steps-v47">
      ...
      <div class="rpg-step-track-v47" aria-label="Progression des pas jusqu’à 20 000">
        ...
        <i class="rpg-step-marker-v47 at-10k"><em>10k</em><b>XP ×1</b></i>
        <i class="rpg-step-marker-v47 at-20k"><em>20k</em><b>XP ×2</b></i>
      </div>
